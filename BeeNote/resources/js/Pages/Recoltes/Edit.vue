<template>
    <AppLayout title="Modifier la Récolte">
        <template #header>
            <div class="space-y-3">
                <!-- Breadcrumbs -->
                <nav class="text-xs text-gray-600 overflow-x-auto">
                    <div class="flex items-center gap-1 whitespace-nowrap">
                        ...
                        <span>›</span>
                        <Link :href="route('ruchers.ruches.recoltes.show', [rucher.id, ruche.id, recolte.id])" class="hover:text-gray-900">
                ...
                <h2 class="text-lg sm:text-xl font-medium text-gray-900">
                    Modifier la récolte du {{ formatDate(recolte.date_recolte) }}
                </h2>
            </div>
        </template>
                ...
                <div class="bg-white border border-gray-200 rounded-sm p-4 sm:p-6">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex flex-col gap-3 pt-4 sm:flex-row sm:justify-end">
                            <Link :href="route('ruchers.ruches.recoltes.show', [rucher.id, ruche.id, recolte.id])"
                            ...
                            <button type="submit" :disabled="form.processing"
                                ...
                                <span v-else>Modifier la récolte</span>
                            </button>
                        </div>
                    </form>
...
// Soumission avec PUT
function submit() {
    form.put(route('ruchers.ruches.recoltes.update', [props.rucher.id, props.ruche.id, props.recolte.id]));
}
</script>