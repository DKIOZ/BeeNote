<template>
    <AppLayout :title="`Modifier ${ruche.nom}`">
        <template #header>
            <div class="flex flex-col space-y-2">
                ...
                <nav class="text-sm text-gray-500">
                    ...
                    <span class="mx-2">›</span>
                    <Link :href="route('ruchers.ruches.show', [rucher.id, ruche.id])" class="hover:text-gray-700">
                    {{ ruche.nom }}
                    </Link>
                    <span class="mx-2">›</span>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            ...
                            <button type="submit" :disabled="form.processing"
                                ...
                                <span v-else>Modifier la ruche</span>
                            </button>
                        </div>
                    </form>
...
const form = useForm({
    nom: props.ruche.nom,
    couleur: props.ruche.couleur || '#ffffff',
    type: props.ruche.type || '',
    statut: props.ruche.statut,
    annee_reine: props.ruche.annee_reine,
    couleur_marquage_reine: props.ruche.couleur_marquage_reine || '',
    date_installation: props.ruche.date_installation || '',
    notes: props.ruche.notes || '',
});

// Soumission avec PUT
function submit() {
    form.put(route('ruchers.ruches.update', [props.rucher.id, props.ruche.id]));
}
</script>